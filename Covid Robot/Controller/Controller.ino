...
void lcd_joystick()
{
      ...
      else if (x_val==x_normal and y_val==y_normal and button_Joy_val==0 and button_L_val==1 and button_R_val==0){lcd.setCursor(0,0); lcd.print("Refilling...    "); lcd.setCursor(0,1); lcd.print("                ");}
