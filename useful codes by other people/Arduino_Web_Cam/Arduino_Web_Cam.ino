/* This program is used to control a stepper motor via a web interface.
   The motor is connected to the ESP8266WiFi board and the Arduino Uno.
   The ESP8266WiFi board is used to send commands to the Arduino Uno.
   The Arduino Uno is used to control two stepper motors.
*/
