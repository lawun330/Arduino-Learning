/* 
  This script is designed for an Arduino Nano to control a TinyLev device.
  It includes definitions for various wait times using no-operation (nop) instructions
  and a macro to output a waveform to a specific port.
*/
